...
const Contact = () => {
  return (
    <div className="min-h-screen bg-gradient-to-tr from-[#d1f1ff] via-white to-[#ffe6ec] flex items-center justify-center py-12 px-6">
      <div className="bg-white rounded-3xl shadow-2xl max-w-5xl w-full overflow-hidden animate-fade-in">
        <div className="grid md:grid-cols-2 gap-10 p-10">
            ...
            <form className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full border border-gray-300 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-blue-400 bg-gray-50" 
                  required 
                />
              </div>
          ...
          <div className="space-y-6 text-gray-700">
            <h2 className="text-3xl font-bold text-[#111827]">📍 Reach Us</h2>
            ...
            <div className="rounded-2xl overflow-hidden border-[3px] border-dashed border-pink-300 mt-6 shadow-xl">
              <iframe
